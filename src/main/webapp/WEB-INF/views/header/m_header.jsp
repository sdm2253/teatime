			...
			<div class="search-container">
				<form id="sFrm" action="totalsearch" method="get">
					<div class="search-bar-container">
						<input class="search-bar" type="text" name="m_search"
							placeholder="  #해쉬태그 or 카테고리명을 검색하세요">
					</div>
				...
				<nav class="nav">
					...
					<div class="nav__content">
						<ul class="nav__items">
							<li class="nav__item"><span class="nav__item-text" onclick="location.href='f_page'">
									친구 </span></li>
							<li class="nav__item"><span class="nav__item-text" onclick="location.href='mypage'">
									마이</span></li>
							<li class="nav__item"><span class="nav__item-text" onclick="location.href='everylogout'">
									로그아웃</span></li>
						</ul>
					</div>
